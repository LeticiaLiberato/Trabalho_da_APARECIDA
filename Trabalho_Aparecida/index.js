const form = document.querySelector('#Fabrica')
...
const salvarProduto = (e) => {
    ...
    let produto = {id: idx, preco, nome, prime}
...
const preencherTabela = () =>{
        ...
        for(const produto of produtos){
            ...
            <tr>
                ...
                <td>${produto.nome}</td>
                <td>${produto.preco}</td>
                <td>${produto.prime ? "Sim" : "Nao"}</td>
                <td>
               
                <img type="button" width="40" src="./img/delete.png" onclick="removerProduto(${produto.id})">
                <img type="button" width="35" src="./img/editar.png"onclick="editarProduto(${produto.id})">
...
const removerProduto = (id) =>{
    const produtos = recuperarLocalStorage();
    const indexProduto = produtos.findIndex((produto) => produto.id)
